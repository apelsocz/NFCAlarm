...
public class Edit extends Fragment implements View.OnClickListener {
    ...
    /** Best practice for creating a Fragment storing data in a Bundle.
     * @return Returns a fragment with the {@link AlarmModel} passed as a parameter.*/
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        String modelAsString =
                savedInstanceState != null && savedInstanceState.containsKey(MODEL_KEY) ?
                        savedInstanceState.getString(MODEL_KEY, "") :
                        getArguments().getString(MODEL_KEY, "");

        currentModel = new AlarmModel(modelAsString);
        uniqueID = currentModel.uniqueID;
        alarms = mAlarmDAO.getModelsAsJSON();

        // find index of model being edited within data store
        savedModelIndex = -1;
        ...
        // update UI to reflect the AlarmModel being edited
...
//        Log.d(NAME, currentModel.json.toString());
    ...
    /** Deflates the current view to a model.
     * @return the {@link AlarmModel} representation of the UI elements customized by the user.
     */
